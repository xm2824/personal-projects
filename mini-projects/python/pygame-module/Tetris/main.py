...
BLOCK_HEIGHT = 20  # heigt of blocks
BLOCK_WIDTH = 10   # wdith of blocks 
BORDER_WIDTH = 4   # length of the border of game area
BORDER_COLOR = (40, 40, 200)  # color the border
...
def main():
    ...
    font_pos_x = BLOCK_WIDTH * SIZE + BORDER_WIDTH + 10  # The X coordinate of the word position in the information display area on the right
    ...
    game_area = None    
    game_over = True
    start = False       # only if start = True，game_over = True, "game over" is showed
    score = 0           
    orispeed = 0.5      
...
def _draw_info(screen, font, pos_x, font_height, score):
    print_text(screen, font, pos_x, 10, f'Scores: ')
