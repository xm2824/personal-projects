...
/////////////////////////////////////////////////// public functions ////////////////////////////////////////////////////////////////////////
    ...
    /**
     * pop 2 elements, let the top-first be a, top-second be b, if(b<a) then push 1 else 0
     */
    @Override
    public void execute(Simulator simulator) {
        ...
        if(simulator.getStack().getStackPointer()<1){
            try {
                throw new Exception("stack has not enough elements, by instruction Less at"+(simulator.getProgramCounter()-1));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
